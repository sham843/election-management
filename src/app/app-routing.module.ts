...
const routes: Routes = [
  ...
  { path: 'login', loadChildren: () => import('./login/login.module').then(m => m.LoginModule), data: { title: 'Login' }, canActivate: [NoAuthGuardService] },
  {
    ...
    component: PartialComponent, children: [
      ...
      { path: 'crm-history/:id', loadChildren: () => import('./partial/booth-management/crm-history/crm-history.module').then(m => m.CrmHistoryModule) ,data:{ title:'CRMHistory',allowedRoles:['1','2'] }},
